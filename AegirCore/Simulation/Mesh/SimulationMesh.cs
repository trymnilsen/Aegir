...
//            List<Vector3d> mL_Vertex;
//            Vector3d[] mVertex;
//            List<Vector3d> mL_VertexWorld;
//            Vector3d[] mVertexWorld;

//            List<Triangle> mL_Triangle;
//            Triangle[] mTri;
...
//            List<int> mL_WaterTriToTest;
//            List<int> mL_MeshTriToTest;
//            List<int> mL_MeshTriSubmerged;
//            List<int> mL_MeshTriEmerged;
//            List<int> mL_VerticesTested;    // 0 = en dessous de l'eau, 1 = au dessus de l'eau
//            List<Triangle> mL_MeshNewTri;
//            List<Vector3> mL_MeshNewVertex;
//            List<float> mL_MeshNewHeight;
//            Dictionary<int, List<Vector3>> mD_TriPts;   // int = N° du triangle, List = liste des points d'intersection
//            public bool IsComputed = false;
//            const float ZERO = float.Epsilon;
...
//            const float mWATERDENSITY = 1027f;  // SI = kg / m3
...
//            protected Model mModelDisplay;
//            public Model ModelDisplay
//            {
//                get { return mModelDisplay; }
//                set { mModelDisplay = value; }
//            }
...
//            public Mesh(Main game) : base(game)
//            {
//                mGame = game;
...
//            {
//                #region Create and load the effect
...
//                #region Create and load the mesh
//                if (mModelName != null)
//                {
...
//                #region Create and load the texture
//                if (mTexAsset != null)
//                {
//                    mTexture = Game.Content.Load<Texture2D>(mTexAsset);
//                    if (mEffect != null && mEffect.Parameters["DiffuseTex"] != null) mEffect.Parameters["DiffuseTex"].SetValue(mTexture);
//                }
//                #endregion

//                #region Create and load the environment map
...
//            }
//            // Compute All time
//            void TransformAllVerticesToWorld()
//            {
...
//                for (int v = 0; v != mVertexWorld.Length; v++)
//                {
//                    float h = mGame.mWaterMesh.GetWaterHeight(mVertexWorld[v]);
...
//                int halfWidth = (int)((mGame.mWaterMesh.Options.SizeX - 1) / 2);
//                int OffsetX = (mGame.mWaterMesh.Options.SizeX - 1) / 2;
//                int OffsetZ = (mGame.mWaterMesh.Options.SizeZ - 1) / 2;
//                int t;
//                int deltaX = 1;
//                int deltaY = 0;
...
//                        // Triangle de l'eau
//                        w0 = mGame.mWaterMesh.mVertex[mGame.mWaterMesh.mTri[w].I0].Position;
//                        w1 = mGame.mWaterMesh.mVertex[mGame.mWaterMesh.mTri[w].I1].Position;
//                        w2 = mGame.mWaterMesh.mVertex[mGame.mWaterMesh.mTri[w].I2].Position;
...
//                }
//            }
//            static int CompareVectorByX(Vector3 u, Vector3 v)
//            {
//                if (u.X < v.X) return -1;
//                else if (u.X == v.X) return 0;
//                else return 1;
//            }
//            static int CompareVectorByY(Vector3 u, Vector3 v)
//            {
//                if (u.Y < v.Y) return -1;
//                else if (u.Y == v.Y) return 0;
//                else return 1;
//            }
//            static int CompareVectorByZ(Vector3 u, Vector3 v)
//            {
//                if (u.Z < v.Z) return -1;
//                else if (u.Z == v.Z) return 0;
//                else return 1;
//            }
//            void CreateMeshNewTri()
//            {
...
//                    #region 2 points en dessous de l'eau
//                    // ============================
//                    else
//                    {
//                        int Ind0 = 0;
...
//                            T.I0 = Ind0;
//                            T.I1 = mL_MeshNewVertex.Count - 1;
//                            mL_MeshNewVertex.Add(ListTemp[0]); mL_MeshNewHeight.Add(ListTemp[0].Y - mGame.mWaterMesh.GetWaterHeight(ListTemp[0]));
//                            T.I2 = mL_MeshNewVertex.Count - 1;
//                            T.color = colorOfTri;
//                            T.vNormal = mTri[t].vNormal;
//                            mL_MeshNewTri.Add(T);
...
//                                    T.I1 = mL_MeshNewVertex.Count - 1;
//                                    mL_MeshNewVertex.Add(ListTemp[p]); mL_MeshNewHeight.Add(ListTemp[p].Y - mGame.mWaterMesh.GetWaterHeight(ListTemp[p]));
//                                    T.I2 = mL_MeshNewVertex.Count - 1;
//                                    T.color = colorOfTri;
//                                    T.vNormal = mTri[t].vNormal;
//                                    mL_MeshNewTri.Add(T);
...
//                }
//            }
//            float DistancePt2Line(Vector3 A, Vector3 B, Vector3 P)
//            {
...
//                }
//            }
//            void ComputeAllForces(GameTime gameTime)
//            {
