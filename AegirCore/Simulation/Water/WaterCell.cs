...
namespace AegirCore.Simulation.Water
{
    public class WaterCell
    {
        ...
        // Ajouts
        public VertexPositionNormalTexture[] mVertex;
        ...
        public Water(Main game) : base(game) { }
        public override void Initialize()
        {
            ...
            mVertex = new VertexPositionNormalTexture[mNbVertices];
        ...
        public void UpdateSea4(GameTime gameTime)
        {
            ...
            for (int i = 0; i < mOptions.SizeX; i++)
            {
                for (int j = 0; j < mOptions.SizeZ; j++)
                {
                    ...
                    {
                        t1 = Vector2d.Dot(wave[w].Dir, new Vector2d(i, j)) * wave[w].Freq + tWave * wave[w].Phase;
        ...
        void Initialize6Waves()
        {
            ...
            wave[0].Dir = new Vector2d((float)Math.Cos(MathHelper.DegreesToRadians(wave[0].Angle)), (float)Math.Sin(MathHelper.DegreesToRadians(wave[0].Angle)));
            ...
            wave[1].Dir = new Vector2d((float)Math.Cos(MathHelper.DegreesToRadians(wave[1].Angle)), (float)Math.Sin(MathHelper.DegreesToRadians(wave[1].Angle)));
            ...
            wave[2].Dir = new Vector2d((float)Math.Cos(MathHelper.DegreesToRadians(wave[2].Angle)), (float)Math.Sin(MathHelper.DegreesToRadians(wave[2].Angle)));
            ...
            wave[3].Dir = new Vector2d((float)Math.Cos(MathHelper.DegreesToRadians(wave[3].Angle)), (float)Math.Sin(MathHelper.DegreesToRadians(wave[3].Angle)));
            ...
            wave[4].Dir = new Vector2d((float)Math.Cos(MathHelper.DegreesToRadians(wave[4].Angle)), (float)Math.Sin(MathHelper.DegreesToRadians(wave[4].Angle)));
            ...
            wave[5].Dir = new Vector2d((float)Math.Cos(MathHelper.DegreesToRadians(wave[5].Angle)), (float)Math.Sin(MathHelper.DegreesToRadians(wave[5].Angle)));
        ...
        public void InitializeRandomWaves1(int nbWaves)
        {
            ...
            for (int w = 0; w < nbWaves; w++)
            {
                ...
                wave[w].Dir = new Vector2d((float)Math.Cos(MathHelper.DegreesToRadians(wave[w].Angle)), (float)Math.Sin(MathHelper.DegreesToRadians(wave[w].Angle)));
