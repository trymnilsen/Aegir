...
//            do
//            {
//                x1 = 2.0f * 4 - 1.0f; //4 By fair dice roll , Todo: Change :)
//                x2 = 2.0f * 4 - 1.0f;
//                w = x1 * x1 + x2 * x2;
//            }
//            while (w >= 1.0f);
...
//            float kz = (float)Math.PI * (2 * m_prime - N) / m_length;
//            return (float)Math.Floor((float)Math.Sqrt(GRAVITY * (float)Math.Sqrt(kx * kx + kz * kz)) / w_0) * w_0;
//        }
