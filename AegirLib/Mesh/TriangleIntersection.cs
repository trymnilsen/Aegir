...
namespace AegirLib.Mesh
{
    public class TriangleIntersection
    {
        ...
        private static int coplanar;
        private static Vector3 p1 = new Vector3();
        private static Vector3 q1 = new Vector3();
        private static Vector3 r1 = new Vector3();
        private static Vector3 p2 = new Vector3();
        private static Vector3 q2 = new Vector3();
        private static Vector3 r2 = new Vector3();

        private static double dp1, dq1, dr1, dp2, dq2, dr2;
        private static Vector3 v1 = new Vector3();
        private static Vector3 v2 = new Vector3();
        private static Vector3 v = new Vector3();
        private static Vector3 N1 = new Vector3();
        private static Vector3 N2 = new Vector3();
        ...
        private static int TRI_INTER_3D(Vector3 p1, Vector3 q1, Vector3 r1, Vector3 p2, Vector3 q2, Vector3 r2, double dp2, double dq2, double dr2)
        {
            if (dp2 > 0f)
            {
        ...
        private static int CONSTRUCT_INTERSECTION(Vector3 p1, Vector3 q1, Vector3 r1, Vector3 p2, Vector3 q2, Vector3 r2)
        {
        ...
        private static int COPLANAR_TRI_3D(Vector3 p1, Vector3 q1, Vector3 r1, Vector3 p2, Vector3 q2, Vector3 r2, Vector3 normal_1, Vector3 normal_2)
        {
        ...
        // ==============================================
        private static int TRI_OVERLAP_2D(Vector3 p1, Vector3 q1, Vector3 r1, Vector3 p2, Vector3 q2, Vector3 r2)
        {
        ...
        private static double ORIENT_2D(Vector3 a, Vector3 b, Vector3 c)
        {
            return ((a.X - c.X) * (b.Y - c.Y) - (a.Y - c.Y) * (b.X - c.X));
        }

        private static int CCW_TRI_INTERSECTION_2D(Vector3 p1, Vector3 q1, Vector3 r1, Vector3 p2, Vector3 q2, Vector3 r2)
        {
        ...
        private static int INTERSECTION_TEST_EDGE(Vector3 P1, Vector3 Q1, Vector3 R1, Vector3 P2, Vector3 Q2, Vector3 R2)
        {
        ...
        private static int INTERSECTION_TEST_VERTEX(Vector3 P1, Vector3 Q1, Vector3 R1, Vector3 P2, Vector3 Q2, Vector3 R2)
        {
            if (ORIENT_2D(R2, P2, Q1) >= 0f)
            {
